# 정답앵커 쌍 — LLM Judge 선호 판단 검증 결과 (RQ6, judge=nim)
...
> **실행 조건**: judge 모델 `deepseek-ai/deepseek-v4-pro`, 쌍마다 debiased 비교(정/역방향 2회 호출)를 **3회 반복** 후 aspect별 다수결로 확정(과반 없으면 tie). 반복 간 판정이 갈린 aspect는 '불안정' 컬럼에 표시 — 단발 채점의 재현성 문제 (docs/reproducibility.md) 통제 목적.

## 쌍별 상세 (다수결 확정 결과)

| id | 정답 risk_level | clarity | faithfulness | risk_coverage | actionability | 불안정 | 위치편향 감지 횟수 |
|---|---|---|---|---|---|---|---|
| hldcc_20 | 위험 | A | A | A | A | - | 0 |
| hldcc_990 | 위험 | A | A | A | A | - | 0 |
| hldcc_37 | 위험 | A | B | A | A | - | 0 |
| hldcc_36 | 안전 | A | A | tie | A | faithfulness | 4 |
| hldcc_2398 | 안전 | tie | tie | tie | A | clarity | 8 |
| lbox_90237_해지조항 | 위험 | A | A | A | A | faithfulness | 1 |
| lbox_90237_연체료 | 위험 | A | tie | A | A | - | 3 |
| lbox_5882 | 안전 | A | A | tie | A | faithfulness, risk_coverage | 3 |
| lbox_11329 | 안전 | A | A | A | A | - | 0 |
| lbox_62108 | 안전 | A | A | A | A | - | 0 |
| hldcc_24 | 위험 | A | tie | A | A | faithfulness | 2 |
| hldcc_1052 | 안전 | A | A | tie | A | risk_coverage | 2 |
| hldcc_2358 | 안전 | A | A | tie | A | faithfulness, risk_coverage | 3 |
| hldcc_932 | 안전 | A | A | tie | A | risk_coverage | 2 |
...
| lbox_37441 | 안전 | A | A | tie | A | faithfulness, risk_coverage | 3 |
| lbox_90237_해지 | 위험 | A | tie | A | A | - | 3 |
| lbox_90237_유익비 | 위험 | A | A | A | A | - | 0 |
| lbox_90237_화재도난 | 위험 | A | A | A | A | - | 0 |
| lbox_90237_해석권 | 위험 | A | A | A | A | - | 0 |
| lbox_146290 | 안전 | A | A | A | A | faithfulness, risk_coverage | 2 |
| lbox_116067 | 안전 | A | A | A | A | risk_coverage | 1 |
| lbox_78728 | 안전 | A | A | A | A | - | 0 |
...
| aihub_0190_연체료 | 위험 | A | A | A | A | faithfulness | 1 |
...
|---|---|---|---|
| clarity | 40/40 | 100% | 1 |
| faithfulness | 36/37 | 97% | 8 |
| risk_coverage | 34/34 | 100% | 7 |
| actionability | 41/41 | 100% | 0 |

위치 편향 의심(정방향/역방향 판단 불일치) 발생: 전체 492회 aspect-판정 중 38회 (8%)
